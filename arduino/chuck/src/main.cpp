...
AnalogSensor AS_soil("soil", 3, 10*MINUTE, 30*MINUTE, SOIL_ADC);
// 1, LM35 analog temperature sensor
AnalogSensor AS_temp("temp", 10, 6*SECOND, 1*MINUTE, TEMP_ADC);
// 2, LDR
AnalogSensor AS_light("light", 10, 6*SECOND, 1*MINUTE, LIGHT_ADC);
